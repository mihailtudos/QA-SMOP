<div class="list-group card dashCard mb-4">
    ...
    @can('student')
        <a href="{{ route('student.topics.index') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"><i class="fas fa-boxes"></i> Topics <span class="badge badge-success badge-pill">{{ auth()->user()->topics->count() }}</span></a>
