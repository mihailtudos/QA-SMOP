...
use App\Notifications\SupervisionMeetingConfirmed;
use App\Project;
...
class MeetingsController extends Controller
{
    ...
    public function store(Request $request, Project $project)
    {
        ...
        $data = $request->validate([
            ...
            'date'          => 'required|date_format:Y-m-d H:i|after:24 hours',
    ...
    public function confirmation(Request $request, Meeting $meeting)
    {
        ...
        $meeting->project->student->notify(new SupervisionMeetingConfirmed(['date' => $meeting->date]));
        $meeting->project->supervisor->notify(new SupervisionMeetingConfirmed(['date' => $meeting->date]));
